...
*****************************************************************************************
	...
	Título: Demo Aux - Tabela nomes
	Descrição: Script auxiliar utilizado para criar as tabelas FirstName e LastName 
		que serão utilizadas nas demonstrações do treinamento.
...
FROM dbo.FirstName AS F
CROSS JOIN dbo.LastName AS L1

-- Gera 12.733.006 registros com este cross join
SELECT COUNT(*)
FROM dbo.FirstName AS F
CROSS JOIN dbo.LastName AS L1
CROSS JOIN dbo.LastName AS L2

-- Gera 3.641.639.716 registros com este cross join
SELECT COUNT_BIG(*)
FROM dbo.FirstName AS F1
CROSS JOIN dbo.LastName AS L1
CROSS JOIN dbo.FirstName AS F2
CROSS JOIN dbo.LastName AS L2
