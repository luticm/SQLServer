...
*****************************************************************************************
	...
	***		Treinamento: SQL23 - SQL Server 2012: Mastering the Database Engine		***
	...
	Título: Modulo 03 - Demo 04 - Database Snapshot
	Descrição: 
...
CREATE DATABASE Mastering
  ...
  (NAME = N'Mastering_Log', 
	FILENAME = N'C:\Temp\Mastering_log.ldf',
	SIZE = 10MB,
	MAXSIZE = 300MB,
	FILEGROWTH = 100MB)	
go
...
ON PRIMARY (NAME = 'Mastering_Data01', FILENAME = N'C:\Temp\MasteringSnap_Data.mdf')
...
UPDATE TabelaGrande
	SET Texto = 'Curso SQL Server 2008 Internals'
	WHERE Codigo = 1
go
...
ON PRIMARY (NAME = 'Mastering_Data01', FILENAME = N'C:\Temp\MasteringSnap2_Data.mdf')
AS SNAPSHOT OF Mastering
go
